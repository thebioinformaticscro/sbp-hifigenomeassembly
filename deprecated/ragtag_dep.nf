process RAGTAG {
    ...
    cat ragtag.scaffold.fasta | grep ">chr" | tr -d '>' | xargs samtools faidx ragtag.scaffold.fasta > ragtag.scaffold.chr.fasta
    cd ..
    ...
    ragtag.py \\
        ...
        ${meta.id}.${meta.type}_ragtag_output/ragtag.scaffold.chr.fasta \\
        $ref
